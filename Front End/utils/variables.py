...
all_models = BERT_models + ALBERT_models + ROBERTA_models + \
...
all_error_ids = errors_sentence_structure_ids + \
    errors_sentence_typos_ids + errors_sentence_purpose_ids
...
all_sentences_checked = all_errors_checked_with_mismatched_length + \
    all_errors_checked_with_matching_lengths
