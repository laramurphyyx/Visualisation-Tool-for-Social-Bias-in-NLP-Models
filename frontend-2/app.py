...
@app.route('/chart1/<list_models>')
def chart1(list_models, list_of_models=all_models, score_types=['neutral_score', 'bias_score', 'nonbias_score'], threshold=0.05, bias_type=None):
...
def chart3(list_of_models=all_models, score_type='neutral_score', bias_type=None, step_size=0.01):
    ...
    for step in np.arange(0, 1 + step_size, step_size):
        ...
        scores = get_list_of_scores(
            list_of_models, score_type, threshold, bias_type)
